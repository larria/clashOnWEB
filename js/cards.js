...
(function (CR) {
  ...
  const CARDS = {
    ...
    knight: { id:'knight', name:'骑士', cost:3, rarity:'普通', kind:KIND.TROOP,
      hp:700, dmg:80, hitSpeed:1.2, range:0.8, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    archers: { id:'archers', name:'弓箭手', cost:3, rarity:'普通', kind:KIND.TROOP,
      hp:125, dmg:50, hitSpeed:1.0, range:5.0, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    goblins: { id:'goblins', name:'哥布林', cost:2, rarity:'普通', kind:KIND.TROOP,
      hp:80, dmg:50, hitSpeed:0.7, range:0.8, sightRange:5.5, speed:SPEED.FAST,
    ...
    spearGoblins: { id:'spearGoblins', name:'投矛哥布林', cost:2, rarity:'普通', kind:KIND.TROOP,
      hp:50, dmg:30, hitSpeed:1.1, range:4.0, sightRange:5.0, speed:SPEED.FAST,
    ...
    bomber: { id:'bomber', name:'炸弹兵', cost:3, rarity:'普通', kind:KIND.TROOP,
      hp:100, dmg:90, hitSpeed:1.9, range:4.5, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    giant: { id:'giant', name:'巨人', cost:5, rarity:'稀有', kind:KIND.TROOP,
      hp:2000, dmg:120, hitSpeed:1.5, range:0.8, sightRange:5.5, speed:SPEED.SLOW,
    ...
    miniPekka: { id:'miniPekka', name:'迷你皮卡', cost:4, rarity:'稀有', kind:KIND.TROOP,
      hp:600, dmg:340, hitSpeed:1.6, range:0.8, sightRange:5.5, speed:SPEED.FAST,
    ...
    musketeer: { id:'musketeer', name:'火枪手', cost:4, rarity:'稀有', kind:KIND.TROOP,
      hp:340, dmg:100, hitSpeed:1.0, range:6.0, sightRange:6.5, speed:SPEED.MEDIUM,
    ...
    valkyrie: { id:'valkyrie', name:'女武神', cost:4, rarity:'稀有', kind:KIND.TROOP,
      hp:650, dmg:120, hitSpeed:1.5, range:1.0, sightRange:5.0, speed:SPEED.MEDIUM,
    ...
    hogRider: { id:'hogRider', name:'野猪骑士', cost:4, rarity:'稀有', kind:KIND.TROOP,
      hp:800, dmg:150, hitSpeed:1.6, range:0.8, sightRange:5.5, speed:SPEED.VERY_FAST,
    ...
    wizard: { id:'wizard', name:'法师', cost:5, rarity:'稀有', kind:KIND.TROOP,
      hp:340, dmg:130, hitSpeed:1.4, range:5.5, sightRange:6.0, speed:SPEED.MEDIUM,
    ...
    pekka: { id:'pekka', name:'皮卡超人', cost:7, rarity:'史诗', kind:KIND.TROOP,
      hp:1800, dmg:680, hitSpeed:1.8, range:0.9, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    prince: { id:'prince', name:'王子', cost:5, rarity:'史诗', kind:KIND.TROOP,
      hp:700, dmg:220, hitSpeed:1.4, range:0.9, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    babyDragon: { id:'babyDragon', name:'飞龙宝宝', cost:4, rarity:'史诗', kind:KIND.TROOP,
      hp:800, dmg:110, hitSpeed:1.5, range:3.5, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    witch: { id:'witch', name:'女巫', cost:5, rarity:'史诗', kind:KIND.TROOP,
      hp:340, dmg:90, hitSpeed:1.1, range:5.0, sightRange:5.5, speed:SPEED.MEDIUM,
    ...
    balloon: { id:'balloon', name:'气球兵', cost:5, rarity:'史诗', kind:KIND.TROOP,
      hp:600, dmg:350, hitSpeed:2.0, range:0.8, sightRange:5.5, speed:SPEED.MEDIUM,
      targets:T.BUILDING, flying:true, count:1, splash:1.5, deployTime:1, color:'#26a69a', radius:0.50,
      special:{ deathDamage:{ dmg:350, splash:1.5, targets:T.ALL } } },
    giantSkeleton: { id:'giantSkeleton', name:'骷髅巨人', cost:6, rarity:'史诗', kind:KIND.TROOP,
      hp:1000, dmg:120, hitSpeed:1.5, range:0.8, sightRange:5.5, speed:SPEED.MEDIUM,
      targets:T.GROUND, flying:false, count:1, splash:0, deployTime:1, color:'#cfd8dc', radius:0.52,
      special:{ deathDamage:{ dmg:500, splash:2.5, targets:T.ALL } } },
    golem: { id:'golem', name:'戈仑石人', cost:8, rarity:'史诗', kind:KIND.TROOP,
      hp:3000, dmg:140, hitSpeed:1.5, range:0.8, sightRange:5.5, speed:SPEED.SLOW,
    ...
    cannon: { id:'cannon', name:'加农炮', cost:3, rarity:'普通', kind:KIND.BUILDING,
      hp:400, dmg:90, hitSpeed:0.8, range:5.5, sightRange:5.5, speed:0,
    ...
    tesla: { id:'tesla', name:'特斯拉电磁塔', cost:4, rarity:'普通', kind:KIND.BUILDING,
      hp:500, dmg:90, hitSpeed:0.7, range:5.0, sightRange:5.0, speed:0,
    ...
    infernoTower: { id:'infernoTower', name:'地狱之塔', cost:5, rarity:'稀有', kind:KIND.BUILDING,
      hp:1300, dmg:60, hitSpeed:0.4, range:6.0, sightRange:6.0, speed:0,
    ...
    bombTower: { id:'bombTower', name:'炸弹塔', cost:4, rarity:'稀有', kind:KIND.BUILDING,
      hp:700, dmg:100, hitSpeed:1.4, range:5.0, sightRange:5.0, speed:0,
    ...
    goblinHut: { id:'goblinHut', name:'哥布林小屋', cost:5, rarity:'稀有', kind:KIND.BUILDING,
      hp:700, dmg:0, hitSpeed:0, range:0, sightRange:0, speed:0,
      targets:T.GROUND, flying:false, count:1, splash:0, deployTime:1, lifetime:45, color:'#689f38', radius:0.55,
      special:{ spawn:{ card:'spearGoblins', count:1, interval:4.9 } } },
    barbarianHut: { id:'barbarianHut', name:'野蛮人小屋', cost:7, rarity:'稀有', kind:KIND.BUILDING,
      hp:900, dmg:0, hitSpeed:0, range:0, sightRange:0, speed:0,
      targets:T.GROUND, flying:false, count:1, splash:0, deployTime:1, lifetime:45, color:'#a1887f', radius:0.58,
      special:{ spawn:{ card:'barbarians', count:1, interval:13.5 } } },
    tombstone: { id:'tombstone', name:'骷髅墓碑', cost:3, rarity:'稀有', kind:KIND.BUILDING,
      hp:300, dmg:0, hitSpeed:0, range:0, sightRange:0, speed:0,
      targets:T.GROUND, flying:false, count:1, splash:0, deployTime:1, lifetime:40, color:'#9e9e9e', radius:0.50,
      special:{ spawn:{ card:'skeletons', count:1, interval:2.9 }, deathSummon:{ card:'skeletons', count:4 } } },
    elixirCollector: { id:'elixirCollector', name:'圣水收集器', cost:5, rarity:'稀有', kind:KIND.BUILDING,
      hp:800, dmg:0, hitSpeed:0, range:0, sightRange:0, speed:0,
    ...
    xbow: { id:'xbow', name:'X连弩', cost:6, rarity:'史诗', kind:KIND.BUILDING,
      hp:700, dmg:30, hitSpeed:0.25, range:11.0, sightRange:11.0, speed:0,
    ...
    mortar: { id:'mortar', name:'迫击炮', cost:4, rarity:'普通', kind:KIND.BUILDING,
      hp:400, dmg:100, hitSpeed:3.0, range:12.0, sightRange:12.0, speed:0,
    ...
    golemite: { id:'golemite', name:'小戈仑', cost:0, rarity:'史诗', kind:KIND.TROOP,
      hp:800, dmg:80, hitSpeed:1.5, range:0.8, sightRange:5.5, speed:SPEED.SLOW,
      targets:T.BUILDING, flying:false, count:1, splash:0, deployTime:0, color:'#7cb342', radius:0.42,
      special:{ deathDamage:{ dmg:100, splash:1.5, targets:T.ALL } }, hidden:true },
  };
