...
export const CARDS = {
  ...
  bombTower: { id:'bombTower', name:'炸弹塔', cost:4, rarity:'稀有', kind:KIND.BUILDING,
    ...
    targets:T.GROUND, flying:false, count:1, splash:2.0, deployTime:1, lifetime:35, color:'#37474f', radius:0.55 },
  ...
  mortar: { id:'mortar', name:'迫击炮', cost:4, rarity:'普通', kind:KIND.BUILDING,
    ...
    targets:T.GROUND, flying:false, count:1, splash:2.0, deployTime:1, lifetime:30, color:'#6d4c41', radius:0.58,
