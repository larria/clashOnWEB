...
**已实装 46 张**(数值已对齐官方 wiki 11 级 × 0.5,核对记录见
LOG.md v0.4.6):

- 部队 24:骑士、弓箭手、哥布林、投矛哥布林、骷髅兵、亡灵、野蛮人、
...
可疑灌木(Suspicious Bush)、炸墙桶(Wall Breakers)、电击小车(Zappies)
