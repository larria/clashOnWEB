...
*Because Sparky deals immense damage but can be easily countered, she is best used as a support troop, ideally behind a high hitpoint tank that targets [[:Category:Building Cards|buildings]] like the [[Golem]] or Giant. Having the tank target buildings means that it will separate itself from the Sparky when units are deployed to defend, making it more difficult for the opponent to hit them both with area damage cards. Additionally, her massive damage may cause the opponent to overcommit and focus too many cards onto the Sparky, allowing the tank to sneak by and deal a significant amount of damage to the [[:Category:Crown Towers|Crown Tower]].
...
*A [[Rage]] [[:Category:Spell Cards|spell]] can throw off the opponent's expectation of when exactly she will fire, possibly allowing her to land a deadly shot on a Crown Tower. This is more effective later as an offense when the opponent has already exhausted several distraction units.
...
*[[Heal Spirit]] also synergizes well in Sparky [[Battle Decks|decks]]. The sudden health boost of a few hundred hitpoints can allow the Sparky to get a single deadly connection that would be otherwise difficult to land on a Crown Tower.
...
*If an [[Knight/Evolution|Evolved Knight]] is placed 1 tile into the opposite lane of where a Sparky is, he can tank two blasts from the Sparky and have the Evolved Knight at high health for a great counterpush.
*[[Clone|Cloning]] a Sparky will retain her current charge, and it will not reset it, and a non-fully charged Sparky will continue charging from where it was left. However, the cloned Sparky will not inherit the state of the original Sparky and will still have to charge from empty.
...
*Sparky is very effective in [[Global Spell|The Floor is Healing]] sub-[[:Category:Modes|mode]]. Since she can OHKO a large majority of troops, she can completely negate the healing that the global [[Heal]] will provide.
...
|-
|6||4 sec||1 sec||Slow (45)||1 sec||5||1.8||1400||Ground||x1||Ground||[[:Category:Troop Cards|Troop]]||{{Rarity|Legendary}}
|}
...
{{#vardefine: hp_11 | 1451 }}
{{#vardefine: dmg_11 | 1331 }}
{{#vardefine: atk_speed | 4.0 }}
...
|1
|Deal a total of 295,000 Damage to enemy [[:Category:Troop Cards|Troops]] or [[:Category:Building Cards|buildings]]
...
|-
|3
|Deal a total of 1,480,000 Damage to enemy Troops or buildings
...
==History==
2016
*The Sparky [[Cards|card]] was added to the game on 3/5/2016, in the [[Version History#May 2016 Update (3/5/2016)|May 2016 Update]].
*On 4/7/2016, the [[Version History#Tournaments Update (4/7/2016)|Tournaments Update]], changed her description. It used to read "''Sparky has a heavy-handed approach in life: Obliterate everything in sight.''"
*On 19/9/2016, the [[Version History#September 2016 Update (19/9/2016)|September 2016 Update]], changed her description. It used to read "''With coils of iron and wheels of wood, the Sparky unloads massive damage to opponents. Overkill isn't in her dictionary.''"
*On 1/11/2016, the [[Version History#November 2016 Update (1/11/2016)|November 2016 Update]], changed her description slightly. It used to read "''Sparky slowly charges up, then unloads MASSIVE area damage. Overkill isn't in her dictionary''".
2017
*On 9/10/2017, the [[Version History#Epic Quests Update (9/10/2017)|Epic Quests Update]], decreased the Sparky's damage by 15% and decreased her attack time interval to 4 seconds (from 5 seconds).
2018
*On 25/4/2018, the [[Version History#Clan%20Wars%20Update%20(25/4/2018)|Clan Wars Update]], fixed a bug where Sparky's hit would reset if she was knocked out of range while charging.
*On 20/6/2018, the [[Version History#Summer%202018%20Update%20(20/6/2018)|Summer 2018 Update]], moved the [[Arenas|Arena]] to unlock the Sparky from Builder's Workshop to Electro Valley.
...
*On 5/12/2018, the [[Version History#December 2018 Update (5/12/2018)|December 2018 Update]], increased the Sparky's range to 5 tiles (from 4.5 tiles). This change was not mentioned in any change notes and was later said to be unintentional by Supercell, and as such it got reverted in 7/12/2018, in a [[Version History#Maintenance Break (7/12/2018)|maintenance break]].
2019
*On 7/1/2019, a [[Version History#Balance Changes (7/1/2019)|Balance Update]], reverted the Sparky to her state on 5/12/2018. More specifically, the Sparky's range was increased to 5 tiles (from 4.5 tiles).
2020
*On 7/1/2020, a [[Version History#Balance Changes (7/1/2020)|Balance Update]], removed the Sparky from all [[Tournament/Special Event Challenges|Draft]] selections. However, she remained in Triple Draft.
*On 3/11/2020, a [[Version History#Balance Changes (3/11/2020)|Balance Update]], increased the Sparky's first attack time interval to 1 second (from 0.5 seconds).
2021 
...
2022
*On 26/10/2022, the [[Version History#2022%20Quarter%203%20Update%20(26/10/2022)|2022 Quarter 3 Update]], fixed a bug where Sparky was not reset when hit by [[Electro Spirit]] at the same time she was being hooked by [[Fisherman]].
2023
*On 19/6/2023, the [[Version History#Card%20Evolution%20Update%20(19/6/2023)|Card Evolution Update]], increased the Level cap of all cards to 15 (from 14). It also fixed an issue with Sparky's charge sound effects.
2025
*On 31/3/2025, the [[Version History#2025 Quarter 1 Update (31/3/2025)|2025 Quarter 1 Update]], decreased the Sparky's hitpoints by 0.06%.

==Gallery==
<gallery>
File:Sparky card render.png|Current card render.
File:Sparky Preview.gif|Current card preview
File:Sparky 1.png|Sparky 1
File:Sparky02.jpg|Sparky 2
</gallery>

== Trivia ==
*The name "Sparky" is a gender-neutral name of Middle English and Old Norse origins from the surname "''Spark''", meaning “''lively''”, “''high-spirited''”, “''sprightly''”, and “''vivacious''”. Despite it being a gender-neutral name, Sparky has been confirmed to be female, according to her [[Cards|card]] description.
**In the French and Chinese language settings of the game, the Sparky's name translates to "Zappy" and "Electromagnetic Gun" respectively.
**In the Turkish language setting of the game, Sparky's name lacks the diminutive suffix, causing it to have a name that translates to just "Spark".
...
*The Sparky's stats are the highest or lowest among all [[:Category:Troop Cards|troops]]. More specifically:
...
*The Sparky has been featured in multiple [[Tournament/Special Event Challenges|special game modes]] outside of the card. More specifically: 
**The Sparky is 1 of 23 troops that has been featured in the [[Troop Rush]] game [[:Category:Modes|mode]], the others being [[Skeletons]], [[Skeleton Dragons]], [[Fire Spirit]], [[Bats]], [[Elite Barbarians]], Firecracker, [[Rascals|Rascal Girls]], [[Royal Hogs]], [[Heal Spirit]], [[Elixir Golem]], [[Guards]], [[Prince]], [[Balloon]], [[Golem]], [[Wall Breakers]], [[Ram Rider]], [[Phoenix]], [[Royal Ghost]], [[Bandit]], [[Lumberjack]], [[Santa Hog Rider]], and the [[Monk]].
**The Sparky is 1 of 3 troops that has been featured in the [[Treasure Hunt|Capture the Troop]] sub-mode of the Treasure Hunt game mode, the others being [[Fisherman]] and the [[Archer Queen]].
**The Sparky is 1 of 14 troops that has been featured with a [[Buff#Rage|Rage]] [[buff]], the others being Electro Spirit, [[Giant]], Zappies, Guards, [[Giant Skeleton]], [[Goblin Giant]], Electro Dragon, Wall Breakers, Electro Giant, [[Mega Knight]], Ram Rider, Electro Wizard, and Royal Ghost.
**The Sparky is 1 of 10 troops that has been featured under the [[Ruler Ability#Special Delivery|Special Delivery]] [[Ruler Ability|ruler ability]], the others being [[Knight]], [[Skeleton Barrel]], [[Mini P.E.K.K.A.|Mini P.E.K.K.A]], [[Musketeer]], [[Wizard]], [[P.E.K.K.A.|P.E.K.K.A]], Giant Skeleton, Golem, and Royal Ghost.
*The Sparky is 1 of 15 troops which bring an excited reaction from the audience upon spawning and brings a collective groan from the audience when defeated, as well as a concerning gasp when the opponent plays her, the others include [[Royal Giant]], Giant, P.E.K.K.A., Giant Skeleton, [[Rune Giant]], Goblin Giant, Golem, [[Bowler]], Electro Wizard, [[Inferno Dragon]], [[Lava Hound]], [[Night Witch]], [[Super Lava Hound]], and the Monk.
*The three notes Sparky makes when charging up are C, E♭, and G♭, making a diminished [https://en.wikipedia.org/wiki/C_minor c-minor] chord if put together.
*There is a [[Loading Screen Hints|Loading Screen Hint]] that directly refers to a nickname for her. It says: "''Calling Sparky a trash can on wheels hurts her feelings.''" This may suggest that Sparky is a sentient being.
...
*A [[Clone|cloned]] Sparky does not fall from the sky when deployed.
*The initial balance change for Sparky on the [[Version History#January Balance Changes (7/1/2019)|7/1/2019 balance changes]] was a range increase to 4.75 tiles (from 4.5 tiles), but it was raised to 5 tiles [https://twitter.com/ClashRoyale/status/1082197094868373505 last minute].
