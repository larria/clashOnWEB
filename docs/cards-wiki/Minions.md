<!-- Minions | source: https://clashroyale.fandom.com/wiki/Minions | fetched: 2026-09-22 -->

{{DISPLAYTITLE:<span style="color: #99CCFF;">Minions</span>}}{{Protection}}{{MagicWords}}{{ClashofClansLink|Minion}}{{Card Infobox|Cost=3|Rarity=Common|Type=Troop|Arena=Training Camp|ReleaseDate=4 January 2016}}{{Quote|Three fast, unarmored flying attackers. Roses are red, minions are blue, they can fly, and will crush you!}}

The Minions is a {{Rarity|Common}} [[Cards|card]] that is unlocked in the [[Training Camp]]. It spawns three single-target, air-targeting, short-ranged, and air [[:Category:Troop Cards|troops]] with low hitpoints and low damage, deployed in a triangular formation. The Minions take the appearance of small, light blue gargoyles with team-colored eyes, an underbite, two large, team-colored horns, two stubby silver wings on their backs, and large hands and legs with vicious-looking claws covered in Dark Elixir, while wearing two team-colored bands on their arms, and producing blackish purple orbs of Dark Elixir as their ammunition. They are also the same as the Minions spawned by the [[Minion Horde]] card. A Minions card costs 3 {{Icon|I=Elixir}} to deploy.

==Strategy==
{{Battle Deck with Card|:Category:Battle Decks using the Minions Card}}
*Being cheap [[:Category:Troop Cards|troops]] with decent total damage, Minions can be a great way to assist ground troops in taking out enemy units, or even take them down on their own. They are also air troops, which means they can't be attacked by ground units, though this can be detrimental if it's better to take down an opposing troop by distracting it with a ground unit and letting the [[:Category:Crown Towers|Crown Tower]] chip its hitpoints.
...
**[[Miner]] pairs well with Minions, as he will reach the Crown Tower directly and provide a decent health pool, which deny assistance from the opponent's Crown Tower against Minions while not being vulnerable to [[:Category:Spell Cards|spells]] or splash units. Even if just one Minion is still alive after a defense, tanking for it with a Miner will force the opponent to address both. It is a decent punishment play when ahead on [[Elixir]] or when the opponent's counter for Minions is out of hand. A similar strategy works with the [[Goblin Drill]], however, one should note that the [[Goblin Drill/Evolution|Evolved Goblin Drill]] won't tank for the Minions due to its threshold mechanic.
...
**[[Royal Delivery]] can counter the Minions for a neutral Elixir trade, while spawning a [[Royal Recruits|Royal Recruit]] to assist with additional defense. This is most recommended to be used when another card is tanking for the Minions.
...
**While it cannot hit them at all, a [[Barbarian Barrel]] will be able to spawn a [[Barbarians|Barbarian]] and distract the Minions long enough to allow the Crown Tower to defeat them. Although this is a +1 Elixir trade, this should only be used if the Barbarian Barrel is also distracting another troop.
...
**[[Skeletons]] or any Spirit card can be deployed in the center to stall them long enough for the Crown Towers to take them out. [[Fire Spirit]] can also be placed closer to them, because its damage is high enough to allow the [[:Category:Crown Towers|Crown Tower]] to OHKO them.
...
***Compared to the Archers, the [[Archers/Evolution|Evolved Archers]] deal more damage, which is enough to 2HKO the Minions, making them more effective against them. They also have longer range, which may allow them to counter them unharmed.
...
**If [[Prince]]'s charge is interrupted by a [[:Category:1-Elixir Cards|1-Elixir troop]], Minions will do damage to him quickly enough to take him down for a +1 Elixir trade. [[Dark Prince]] can also be countered if the distraction unit is [[Electro Spirit]] or [[Ice Spirit]], resulting in a neutral Elixir trade.
...
*An [[Musketeer/Evolution|Evolved Musketeer]] can counter the Minions with her three sniper shots, since they do more than enough damage to OHKO them. However, the player could benefit from this by using a card that the Evolved Musketeer would get more value countering with her sniper shots, like Baby Dragon.
*Against a [[Skeleton Barrel]], the Minions can be placed on top of it. After destroying it, the Minions will fly away from it, avoiding its death damage, only to return back afterwards to defeat the Skeletons that spawn. This is a good way to counter the Skeleton Barrel for a neutral Elixir trade, while also reducing Crown Tower damage taken and saving the Minions' hitpoints for a counterattack. This should not be done against the [[Skeleton Barrel/Evolution|Evolved Skeleton Barrel]], as it comes with two drops, so they will be destroyed in the process while the second drop has all of Skeletons alive.
...
*An [[Tesla/Evolution|Evolved Tesla]]'s pulses can weaken Minions and might take them out if they have been damaged previously. This helps when they are attempting to distract the player's troops for a more dangerous unit. A similar principle also works with the [[Cannon/Evolution|Evolved Cannon]], with the barrage damage being high enough to defeat them.
*The [[Electro Dragon]] is able to chain onto the three Minions with one attack, while also 2HKOing them. Though this costs a -2 Elixir trade, he will be very healthy for a counterpush. The [[Electro Dragon/Evolution|Evolved Electro Dragon]] may be able to finish them with only one attack if it does not bounce away from them or if it does not hit the Crown Tower.
*Minions can take down a lone [[Battle Ram]] when placed a in front of it. However, the [[Barbarians]] that spawn once it dies may be able to get some hits on the Crown Tower, requiring the usage of another distraction card, such as [[Skeletons]], Electro Spirit, or Ice Spirit. This results in a neutral Elixir trade and healthy Minions that can be used for a counterattack. This also applies to the [[Battle Ram/Evolution|Evolved Battle Ram]].
...
*Depending on what the player needs in their [[Battle Decks|deck]], Minions can be substituted with other similar cards.
...
|-
|3||1.2 sec||0.5 sec||Fast (90)||1 sec||2.5||1000||Air & Ground||x3||Air||[[:Category:Troop Cards|Troop]]||{{Rarity|Common}}
|}
<!--
...
{{#vardefine: hp_base | 230 }}
{{#vardefine: dmg_base | 107 }}
...
==History==
2016
*The Minions [[Cards|card]] was added with [[Version History#Softlaunch on iOS (4/1/2016)|Clash Royale's game launch]] on 4/1/2016 {{Balance|Add}}.
*On 29/2/2016, the [[Version History#March 2016 Update (29/2/2016)|March 2016 Update]] decreased the Minions' Sight Range to 5.5 tiles (from 6 tiles) {{Balance|Buff}}.
*On 3/5/2016, the [[Version History#May 2016 Update (3/5/2016)|May 2016 Update]] increased the {{Rarity|Common}} card Level Cap to 13 (from 12) {{Balance|Buff}}. The update also fixed the "range bug" by decreasing the Minions' Range to 2 tiles (from 2.5 tiles) {{Balance|Nerf}}, but maintaining their effective Range.
2018
*On 20/6/2018, the [[Version History#Summer 2018 Update (20/6/2018)|Summer 2018 Update]] gave the Minions a new a delay between each other when deployed, with a Minion spawning 0.15 seconds after the previous one {{Balance|Add}}. It also moved the [[Arenas|Arena]] required to unlock this card from Bone Pit to [[Training Camp]] {{Balance|Buff}}.
2019
*On 1/7/2019, the [[Version History#July 2019 Update (1/7/2019)|July 2019 Update]] decreased the Minions' Range to 1.6 tiles (from 2 tiles) {{Balance|Nerf}}, classifying their Range as "Melee: Long".
2020
*On 2/6/2020, a [[Version History#Balance Changes (2/6/2020)|Balance Update]] decreased the delay between each Minion deployment to 0.1 seconds (from 0.15 seconds) {{Balance|Buff}}.
*On 3/11/2020, a [[Version History#Balance Changes (3/11/2020)|Balance Update]] added a card render to the Minions' card info screen {{Balance|Add}}.
2021
...
2022
*On 7/12/2022, a [[Version History#Balance Changes (7/12/2022)|Balance Update]] increased the Minions' Damage by 15% {{Balance|Buff}}.
2023
...
2025
*On 31/3/2025, the [[Version History#2025 Quarter 1 Update (31/3/2025)|2025 Quarter 1 Update]] made it so that Minions' spawn formation would be correctly mirrored depending on which side of the Arena they were placed {{Balance|Neutral}}.
*On 4/8/2025, the [[Version History/2025#Pass Royale and more (4/8/2025)|August 2025 Update]] increased the Minions' Hitpoints by 16% {{Balance|Buff}} and their Range to 2.5 tiles (from 1.6 tiles) {{Balance|Buff}}, removing their Melee range classification.
*On 7/8/2025, a [[Version History#Maintenance Break (7/8/2025)|maintenance break]], decreased the Minions' Hitpoints by 14%{{Balance|Nerf}}.
*On 1/9/2025, a [[Version History#Balance Changes (1/9/2025)|Balance Update]] increased the Minions' Attack Period to 1.1 seconds (from 1 second){{Balance|Nerf}}.
*On 6/10/2025, a [[Version History #Balance Changes (6/10/2025|Balance Update]] decreased the Minions' Damage by 9%{{Balance|Nerf}}.
...
2026
*On 2/2/2026, the [[Version History#Pass Royale and more (2/2/2026)|February 2026 Update]] increased the Minions' Attack Period to 1.2 seconds (from 1.1 seconds){{Balance|Nerf}}.

==Gallery==
<gallery>
File:Minions Card Render.png|Current card render.
File:Minion Alone.png|A lone Minion from the card render.
File:Minion Alone 2.png|Minion 1.
File:Minion Alone 3.png|Minion 2.
File:Minion Alone 4.png|Minion 3.
File:Minion With Background.jpg|A Minion in a background.
</gallery>

==Trivia==
*The Minions' design resembles [https://en.wikipedia.org/wiki/Gargoyle_(monster) gargoyles]. The gargoyle is a fantasy and horror monster inspired by the [https://en.wikipedia.org/wiki/Gargoyle gargoyle architectural element]. While they were believed in mythology to frighten away evil spirits, the idea of such statues physically coming to life is a more recent notion. They are usually magically animated or transformed stone, but have animal or chimera traits and are often guardians of a place such as a cathedral or castle. They can also be depicted as vessels for demonic possession or as a statue-resembling living species.
**In the French and Japanese language settings of the game, the Minions' name translates to "Gargoyles".
*The Minions are 1 of 19 [[:Category:Troop Cards|troops]] which first existed in Clash of Clans, the others being [[Archers]], [[Goblins]], [[Skeletons]], [[Barbarians]], [[Giant]], [[Valkyrie]], [[Wizard]], [[Hog Rider]], [[Witch]], [[P.E.K.K.A.]], [[Balloon]], [[Golem]], [[Wall Breakers]], [[Bowler]], [[Cannon Cart]], [[Phoenix]], [[Lava Hound]], and the [[Archer Queen]].
**The Minions resemble the Level 1-2 Minion from Clash of Clans. Their [[Star Points|Star Level 3 skin]] resembles the Level 7-8 Minion in Clash of Clans.
...
*The Minions are one of the first troop cards to be featured in a [[Training Camp|Trainer]]'s [[Battle Decks|deck]], alongside the Archers, Knight, [[Spear Goblins|Sperar Goblins]], Goblins, [[Bomber]], Skeletons, Barbarians, Minion Horde, [[Mini P.E.K.K.A.]], [[Musketeer]], Giant, Valkyrie, Wizard, Hog Rider, [[Baby Dragon]], [[Skeleton Army]], [[Witch]], P.E.K.K.A., Prince, and Balloon.
*In the card's description, the "''Roses are red, Minions are blue''" line is from the [https://en.wikipedia.org/wiki/Roses_Are_Red classic love poem] starting "''Roses are red, Violets are blue''".
**In the Spanish, Japanese, and Portuguese language settings of the game, the Minions' card description says "''It is a bird? It is a plane? No, it's a super minion!''", which is a reference to [https://en.wikipedia.org/wiki/Superman Superman].
**In the Korean language setting of the game, the Minions' card description says "''fly like butterflies, sting like bees''", which is a reference to a quote mentioned by [https://en.wikipedia.org/wiki/Muhammad_Ali Muhammad Ali].
...
**According to a Clash-A-Rama comic [https://clasharama.fandom.com/wiki/Clash-A-Rama!_Comic_Strips?file=BRING-YOUR-CHILD-TO-WORK-DAY_Final.jpg strip], a Minion is the Mega Minion's child.
...
*The Minions are 1 of 20 cards that are unavailable in [[Mirror]] [[Tournament/Special Event Challenges|mode]], the others being [[Cannon]], [[Mortar]], [[Tesla]], [[Goblin Hut]], [[Tombstone]], [[Bomb Tower]], [[Inferno Tower]], [[Barbarian Hut]], [[Furnace]], [[Elixir Collector]], [[Freeze]], [[Clone]], [[X-Bow]], [[Golden Knight]], [[Skeleton King]], Archer Queen, [[Mighty Miner]], [[Little Prince]], and the [[Monk]].
*The Minions are the subject of an [[Emotes|Emote]].
*The Minions' range was shown as 2 instead of "Ranged" before the [[Version History#July 2019 Update (1/7/2019)|July 2019 Update]].
*The Minions were featured in the winning deck of the [https://www.youtube.com/live/DVY2TndGf4U?si=ptuVz0tHkkkDIvEl Crown Championship Global Series Tournament], by a player called Sergioramos:).
*Before the Minions' card release, the Minions' Hitpoints were increased by 5%.

==In other languages==
{{Other languages|frmeaning=Gargoyles.|jpmeaning=Gargoyles.|cnmeaning=Undead.|cntmeaning=Undead.|thmeaning=Drones.|fr=Gargouilles|de=Lakaien|es=Esbirros|it=Sgherri|nl=Gunstelingen|no=Lakeier|tr=Minyonlar|jp=ガーゴイル|kr=미니언|ru=Миньоны|ar=كائنات المينيون|pt=Servos|cn=亡灵|cnt=亡靈|fa=مینیون|id=Minion|ms=Konco|th=ลูกกระจ๊อก|fi=Kätyrit|vi=Minion}}
