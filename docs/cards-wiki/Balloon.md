<!-- Balloon | source: https://clashroyale.fandom.com/wiki/Balloon | fetched: 2026-09-22 -->

{{DISPLAYTITLE: <span style="color: #b300b3;">Balloon</span>}}
{{Protection}}{{MagicWords}}{{ClashofClansLink}}{{SubpageNavBox|Hero=Yes}}{{Card Infobox|Cost=5|Rarity=Epic|Type=Troop|Arena=Royal Arena|ReleaseDate=4 January 2016}}
{{Quote|As pretty as they are, you won't want a parade of THESE balloons showing up on the horizon. Drops powerful bombs and when shot down, crashes dealing area damage.}}

The Balloon is an {{Rarity|Epic}} [[Cards|card]] that is unlocked from the [[Arenas|Royal Arena (Arena 7)]]. It spawns a single-target, [[:Category:Building Cards|building]]-targeting, melee, air [[:Category:Troop Cards|troop]] with high hitpoints and very high damage. When defeated, it drops a bomb which explodes after 3 seconds, dealing moderate damage. It is a hot air balloon with a team-colored envelope and a wooden basket with sacks held together by patches and ropes, and is piloted by a [[Bomber]]. A Balloon card costs 5 [[Elixir]] to deploy.

==Strategies==
{{Battle Deck with Card|:Category:Battle Decks using the Balloon Card}}
*The somewhat sturdy Balloon can easily devastate [[:Category:Tower Troop Cards|Crown Towers]] with its extremely high damage, which is further augmented by a tank protecting it and additional support [[cards]].
...
**An attack strategy is pairing the [[Lumberjack]] with the Balloon, most commonly called LumberLoon. The Lumberjack tanks for the Balloon and drops a [[Rage]] [[:Category:Spell Cards|spell]], boosting the Balloon and allowing it to get multiple hits on the tower. However, anti-air cards with enough damage output like the [[Minion Horde]], Hunter, and [[Three Musketeers]], or [[:Category:Building Cards|buildings]] like the [[Inferno Tower]] and [[Tesla/Evolution|Evolved Tesla]] will be able to counter this push. If using this strategy, the player should make sure they have other alternatives to back up the Balloon, such as [[Fireball]] or a [[Baby Dragon]]. It can be more beneficial for the player to do this as a counterattack to allow [[Elixir]] to generate so that the player can deploy more support units.
...
**Occasionally, a [[Clone]] spell can be used with the Balloon. Similarly to Freeze, it acts as a surprise to the opponent, dealing massive damage. Clone also pushes the Balloon closer to the [[Princess Towers|Crown Tower]], possibly attacking it earlier, as well as bypassing certain defensive building setups.
...
{{StatusEffects}}
{{StatisticsSubheader|Balloon Attributes}}
...
|-
|5||2 sec||0.2 sec||Medium (60)||1 sec||Melee: Short (0.1)||Buildings||x1||Air||[[:Category:Troop Cards|Troop]]||{{Rarity|Epic}}
|}
...
{{#vardefine: hp_11 | 1679 }}
{{#vardefine: dmg_11 | 640 }}
{{#vardefine: atk_speed | 2.0 }}
{{#vardefine: death_11 |  240}}
...
==History ==
2016  
*The Balloon [[Cards|card]] was added with Clash Royale's game launch on 4/1/2016.
*On 2/2/2016, the [[Version History#February 2016 Update (2/2/2016)|February 2016 Update]], added the Death Damage statistic to the Balloon's card info screen.
*On 29/2/2016, the [[Version History#March 2016 Update (29/2/2016)|March 2016 Update]], decreased the Balloon's sight range to 7.7 tiles (from 8 tiles).
*On 23/3/2016, a [[Version History#Balance Changes (23/3/2016)|Balance Update]], increased the Balloon's hitpoints by 5%.
*On 3/5/2016, the [[Version History#May%202016%20Update%20(3/5/2016)|May 2016 Update]], increased the size of the Balloon's hitpoint bar to prevent it from being recognized as a low-health troop when encountered. The update also fixed the “range bug”, which decreased the Balloon's range to 0.1 tiles (from 0.4 tiles), but its effective range was unchanged.
*On 15/12/2016, the [[Version History#December 2016 Update (15/12/2016)|December 2016 Update]], increased the Balloon's death damage by 105% and its death damage explosion radius to 3 tiles (from 2 tiles).
2017
*On 19/4/2017, a [[Version History#Balance Changes (19/4/2017)|Balance Update]], increased the Balloon's death damage time to 3 seconds (from 1 second).
2018
*On 6/8/2018, a [[Version History#Balance Changes (6/8/2018)|Balance Update]], allowed the Balloon to be knocked back.
...
2019
*On 28/1/2019, the [[Version History#January%202019%20Update%20(28/1/2019)|January 2019 Update]], moved the [[Arenas|Arena]] to unlock the Balloon from Bone Pit to Builder’s Workshop.
...
*On 26/11/2019, the [[Version History#End%20of%20November%202019%20Update%20(26/11/2019)|End of November 2019 Update]], added a card render to the Balloon's card info screen.
2021
*On 30/3/2021, the [[Version History#2021%20Quarter%201%20Update%20(30/3/2021)|2021 Quarter 1 Update]], decreased the Balloon's death damage by 27%.
...
2022 
*On 3/2/2022, a [[Version History#Balance%20Changes%20(3/2/2022)|Balance Update]], decreased the Balloon's damage by 33%, but also decreased its attack time interval to 2 seconds (from 3 seconds).
*On 26/10/2022, the [[Version History#2022%20Quarter%203%20Update%20(26/10/2022)|2022 Quarter 3 Update]], moved the Arena to unlock the Balloon from Builder's Workshop to Royal Arena.
2023
*On 19/6/2023, the [[Version History#Card%20Evolution%20Update%20(19/6/2023)|Card Evolution Update]], increased the Level cap of all cards to 15 (from 14). It also added the Siege Weapon [[Card Mastery]] task for the Balloon.
2025
*On 31/3/2024, the [[Version History#2025 Quarter 1 Update (31/3/2025)|2025 Quarter 1 Update]], decreased the Balloon's hitpoints by 0.05%.
2026

* On 2/2/2026, a Balance Update, increased the Balloon's damage by 0.02%.

==Gallery==
<gallery>
File:Balloon card render.png|Current card render.
File:Chinese Balloon card render.png|Balloon’s card render in the Chinese version of the game.
File:Ballon Preview.gif|Current card preview
File:Balloon red.png|Balloon 1
File:Balloon 1.png|Balloon 2
File:Balloon 2.png|Balloon 3
</gallery>

==Trivia==
*The first use of [https://en.wikipedia.org/wiki/History_of_military_ballooning hot air balloons in warfare] was in 1849, where the Austrian imperial forces besieging Venice attempted to float some 200 paper hot air balloons each carrying an 11–14 kg bomb that was to be dropped from the balloon with a time fuse over the besieged city. Before that, Balloons were used in wars exclusive for reconnaissance purposes, the first instance being in the Battle of Fleurus in 1794, used by the French  against the Austrians. 
...
*The Balloon is 1 of 19 [[:Category:Troop Cards|troops]] which first existed in Clash of Clans, the others being [[Minions]], [[Archers]], [[Goblins]], [[Skeletons]], [[Barbarians]], [[Giant]], [[Valkyrie]], [[Wizard]], [[Hog Rider]], [[Witch]], [[P.E.K.K.A.|P.E.K.K.A]], [[Golem]], [[Wall Breakers]], [[Bowler]], [[Cannon Cart]], [[Phoenix]], [[Lava Hound]], and the [[Archer Queen]].
**The Balloon resemble the Level 1-2 Balloon from Clash of Clans. Its [[Star Points|Star Level 3 skin]] resembles the Level 3-4 Balloon in Clash of Clans, only without its crown.
**Its [[Cards|card]] image and render are identical to the old render of the Balloon in Clash of Clans, except for the re-skinned envelope and color change.
...
**According to Clash of Clans, Balloons are "promoted" Wall Breakers. The Skeleton riding the Balloon is visually identical to a Level 1 [https://clashofclans.fandom.com/wiki/Wall_Breaker Wall Breaker] in Clash of Clans.
...
**The bombs in the Balloon and Bomber's card renders are identical.
*The Balloon has the shortest range of all troops, with a range of 0.1 tiles.
*The Balloon is one of the first troop cards to be featured in a [[Training Camp|Trainer]]'s [[Battle Decks|deck]], alongside the Minions, Archers, [[Knight]], [[Spear Goblins]], Goblins, Bomber, Skeletons, Barbarians, [[Minion Horde]], [[Mini P.E.K.K.A.|Mini P.E.K.K.A]], [[Musketeer]], Giant, Valkyrie, Wizard, Hog Rider, [[Baby Dragon]], Skeleton Army, Witch, P.E.K.K.A, and [[Prince]].
...
*The Balloon has been featured in multiple [[Tournament/Special Event Challenges|special game modes]] outside of the card. More specifically:
**The Balloon is 1 of 23 troops that has been featured in the [[Troop Rush]] game [[:Category:Modes|mode]], the others being Skeletons, Skeleton Dragons, [[Fire Spirit]], Bats, [[Elite Barbarians]], [[Firecracker]], Rascal Girls, Royal Hogs, [[Heal Spirit]], Elixir Golem, Guards, Prince, Golem, Wall Breakers, Ram Rider, [[Sparky]], Phoenix, Royal Ghost, Bandit, [[Lumberjack]], [[Santa Hog Rider]], and the [[Monk]].
**The Balloon is 1 of 2 troops that has been featured with a [[Buff#Death Spawn|Death Spawn]] [[buff]], the other being Giant Skeleton.
*Its description is based on the Clash of Clans [https://www.youtube.com/watch?v=4Hm5OktGsQ8 Balloon Parade commercial].
*The Balloon's design strongly resembles that of the [https://cnc.fandom.com/wiki/Kirov_airship_(Red_Alert_iPhone) Kirov Airship] from the [https://en.wikipedia.org/wiki/Command_%26_Conquer Command and Conquer] games. They are both airships that deal massive damage to things right under them, both are very slow and can only target ground units.
*The Balloon's basket looks similar to the hull of the [[Rocket]].
*In Touchdown, if a Balloon is still on the [[Arenas|Arena]] after a touchdown has been scored (unless it scored it itself), will have its dropped bomb cleared.
*Unlike other troops, the Balloon does not disintegrate into [[Elixir]] when defeated.
*The Balloon is the subject of 2 [[Emotes]].
*The Balloon was featured in the winning deck of the [https://www.youtube.com/live/pRfrjMiHbQA?si=P2kVLJUlXH1SZoHm Clash Royale League 2021 Tournament], by a player called Mugi.
